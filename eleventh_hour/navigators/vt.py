...
class VDFLL:
    ...
    def code_errors(self):
        return np.array(self.__code_error_log)

    @property
    def ferrors(self):
        return np.array(self.__ferror_log)

    @property
    def prange_errors(self):
        return np.array(self.__prange_error_log)

    @property
    def prange_rate_errors(self):
        return np.array(self.__prange_rate_error_log)
