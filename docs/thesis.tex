...
\usepackage{template/aums}       % For Master's papers
% \usepackage{template/auphd}     % For Ph.D.
...
\title{The Eleventh Hour}
\author{J. Tanner Koza} 
\date{May 3, 2024} %date of graduation
\copyrightyear{2024} %copyright year

\keywords{direct position estimation, software-defined receiver, one-step receiver architecture}
...
\professor{Scott M. Martin, Chair, Assistant Professor of Mechanical Engineering}
